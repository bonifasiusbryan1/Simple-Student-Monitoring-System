        ...
        <div class="card-body">
            <div class="grid">
                <div class="grid-item">
                    ...
                    <div class="nama mt-2">{{ $departemen->nama }}</div>
                </div>
                <div class="grid-item">
                ...
                <div class="grid-item">
                    ...
                    <div class="email mt-2">{{ $departemen->email }}</div>
                </div>
                <div class="grid-item">
                    <label for="notelp">Nomor Telepon</label>
                    <div class="notelp mt-2">{{ $departemen->notelp }}</div>
                </div>
                <div class="grid-item">
                    <label for="alamat">Alamat</label>
                    <div class="alamat mt-2">{{ $departemen->alamat }}</div>
                </div>
                <div class="grid-item">
                    <label for="kabkota">Kabupaten/Kota</label>
                    <div class="kabkota mt-2">{{ $departemen->kabkota }}</div>
                </div>
                <div class="grid-item">
                    <label for="provinsi">Provinsi</label>
                    <div class="provinsi mt-2">{{ $departemen->provinsi }}</div>
                </div>
                <div class="d-flex justify-content-between align-items-center grid-item-last grid-item-nm">
                    ...
                    <a href="/editprofile/{{ auth()->user()->role }}" class="custom-simpan">EDIT</a>
                </div>
            </div>
        </div>
    </div>
