...
<div class="container p-0 mt-4">
    <div class="card">
        ...
        <div class="card-body">
            <form action="/verifikasi/skripsi/{{ $mahasiswa->nim }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid-m-skripsi">
                    ...
                    <div class="grid-item">
                        ...
                        <select name="semester" class="semester mt-2">
                            @foreach ($semesterSkripsi as $semester)
                                <option value="{{ $semester }}" {{ old('semester', $skripsi->semester) == $semester ? 'selected' : '' }}>
                                    {{ $semester }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="grid-item">
                        ...
                        <input type="text" name="nilai" class="nilai mt-2" id="nilai" value="{{ old('nilai', $skripsi->nilai) }}">
                        @error('nilai')
                        <div class="text-danger">
                            {{ $message }}
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-start grid-item-last">
                        <a href="/batalverifikasi/skripsi/{{ $mahasiswa->nim }}" class="btn-custom-verifikasi">Batalkan Verifikasi</a>
                    ...
                    <div class="d-flex justify-content-between align-items-start grid-item-last grid-item-m">
                        ...
                        <a href="/verifikasi/skripsi" class="btn-custom-batal" >BATAL</a>
                    </div>
                    ...
                    <div class="modal fade" id="simpan" tabindex="-1" aria-labelledby="simpanLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Tetap simpan Perubahan data Skripsi?
                            </div>
