        ...
        <div class="card-header justify-content-center align-items-center">
            <div class="container text-center w-50"> Daftar 
                ...
                @elseif ($listStatus == 'belum')
                    Belum
                @endif
                Lulus Skripsi Mahasiswa Informatika Fakultas Sains dan Matematika UNDIP Semarang
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                @if ($listStatus == 'sudah')
                    <table class="table table-bordered text-center">
                        ...
                        @foreach ($rekapSkripsi as $index => $mahasiswa)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>{{ $mahasiswa['nim'] }}</td>
                ...
                <div class="d-flex justify-content-end align-items-center">
                    <a href="/cetak/list/skripsi/{{ $angkatan }}/{{ $listStatus }}" class="btn-cetak">Cetak</a>
                </div>
            </div>
        </div>
    </div>
