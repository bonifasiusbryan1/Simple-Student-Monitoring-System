...
<div class="container p-0 mt-4">
    <div class="card">
        ...
        <div class="card-body">
            <form action="/irs/{{ auth()->user()->role }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid-m-irs">
                    ...
                    <div class="d-flex justify-content-between align-items-end grid-item-m">
                        ...
                        <a href="/export/fileirs/{{ $mahasiswa->nim }}/1" data-download-link id="downloadLink">Download File Upload</a>
                    </div>
